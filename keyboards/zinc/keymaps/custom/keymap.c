...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = { \
   ...
   * |------+------+------+------+------+------|             |------+------+------+------+------+------|
   * | Ctrl |ADJUST| Alt  | Win  |Space |LOWER |             | RAISE| Space| Left | Down |  Up  | Right|
   * `-----------------------------------------'             `-----------------------------------------'
   */
[_QWERTY] = LAYOUT_ortho_4x12(
      ...
      KC_LCTL,  ADJUST,   KC_LALT,KC_LGUI, KC_SPC,LOWER,                       RAISE,  KC_SPC,  KC_LEFT, KC_DOWN, KC_UP,   KC_RGHT \
      ),
  ...
  [_RAISE] = LAYOUT_ortho_4x12( \
      ...
      _______, KC_F1,   KC_F2,   KC_F3,   KC_F4,   KC_F5,                     KC_LEFT, KC_DOWN, KC_UP,   KC_RGHT, _______, KC_BSLS, \
      _______, KC_F7,   KC_F8,   KC_F9,   KC_F10,  KC_F11,                    KC_F6,   KC_F12,  KC_MINS, KC_EQL,  KC_LBRC, KC_RBRC, \
      _______, _______, _______, _______, _______, _______,                   _______, _______, KC_MNXT, KC_VOLD, KC_VOLU, KC_MPLY \
      ),
